      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full max-w-md grid-cols-2" data-testid="tabs-list">
            ...
            <TabsTrigger value="recruiter" data-testid="tab-recruiter">
            ...
            {jdAnalysis?.answerAlignment && jdAnalysis.answerAlignment.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Analysis of candidate responses with job description relevance scores and reasoning</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    {jdAnalysis.answerAlignment.slice(0, 5).map((item: any, index: number) => {
            ...
            {jdAnalysis?.questionRelevance && jdAnalysis.questionRelevance.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Evaluation of interviewer questions with job description alignment and detailed reasoning</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    {jdAnalysis.questionRelevance.slice(0, 5).map((item: any, index: number) => {
