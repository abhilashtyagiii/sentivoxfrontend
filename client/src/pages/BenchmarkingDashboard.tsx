        ...
        <Card data-testid="card-avg-question-relevance">
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-avg-question-relevance">
              {avgScores.questionRelevance.toFixed(1)}%
            </div>
          </CardContent>
        </Card>
        ...
        <Card data-testid="card-avg-flow-continuity">
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-avg-flow-continuity">
              {avgScores.flowContinuity.toFixed(1)}%
            </div>
          </CardContent>
        </Card>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-medium">{benchmark.avgQuestionRelevance.toFixed(1)}%</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-medium">{benchmark.avgFlowContinuity.toFixed(1)}%</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-medium">{benchmark.avgFollowUpQuality.toFixed(1)}%</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-medium">{benchmark.avgMissedFollowUps.toFixed(1)}</span>
                    </div>
