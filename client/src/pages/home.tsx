      ...
      <section id="tryout" data-section className="immersive-section relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Upload your interview audio and job description in any order, 
            then watch Sentivox analyze and provide deep insights.
          </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-gray-900 to-gray-800 border-2 border-cyan-400/50 rounded-2xl p-8 text-center">
                ...
                <Button 
                  ...
                  size="lg"
                  className="sentivox-gradient pulse-glow text-white text-2xl px-16 py-8 rounded-full hover:scale-110 transition-all duration-300 shadow-2xl font-bold"
